...
- [ ] 2.1 Conferir o botão "Salvar alterações" (`Candidato/Perfil/Edit.jsx`) com texto centralizado, inclusive durante o estado de envio (ícone trocado para `Loader2`)
- [ ] 2.2 Conferir botões com ícone em outras telas representativas (ex.: `Coord/Vagas/Form.jsx`, diálogos com "Cancelar"/"Remover") nos tamanhos usados (`default`, `sm`, `lg`)
- [ ] 2.3 Conferir que botões só-texto (sem ícone) continuam com a mesma aparência de antes
- [ ] 2.4 Conferir tema claro e escuro
- [ ] 2.5 Rodar `openspec validate centralizar-texto-botoes --strict` e corrigir eventuais pendências
