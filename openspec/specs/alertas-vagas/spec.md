# alertas-vagas Specification

## Purpose
Define como o candidato assina alertas de vagas por e-mail: a largura da página, a separação entre o que o identifica (e-mail e envio) e o que ele escolhe receber (áreas, tipos e modalidades), como essa separação se comporta conforme a largura da tela, e as condições de conta exigidas para criar, alterar e cancelar um alerta.
## Requirements
