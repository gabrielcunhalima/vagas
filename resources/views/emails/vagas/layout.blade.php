...
.header h1{color:#fff;font-size:1.25rem;margin:8px 0 0;font-weight:700;}
.header p{color:rgba(255,255,255,0.75);font-size:0.82rem;margin:4px 0 0;}
.body{padding:32px;}
.footer{background:#F1F5F4;padding:16px 32px;text-align:center;font-size:0.75rem;color:#6C757D;border-top:1px solid #E9ECEF;}
.btn{display:inline-block;padding:12px 28px;background:#0D9571;color:#fff!important;font-weight:700;border-radius:8px;font-size:0.95rem;text-decoration:none!important;margin:16px 0;}
.info-box{background:#F8F9FA;border-left:4px solid #0D9571;border-radius:6px;padding:14px 16px;margin:16px 0;font-size:0.875rem;color:#3E3E3F;}
.info-row{display:flex;gap:8px;margin-bottom:6px;font-size:0.875rem;}
.info-label{font-weight:700;color:#495057;min-width:120px;}
.info-value{color:#3E3E3F;}
h2{font-size:1.15rem;font-weight:700;color:#2C4A44;margin:0 0 12px;}
p{font-size:0.9rem;line-height:1.65;color:#3E3E3F;margin:0 0 12px;}
</style>
</head>
<body>
<div class="wrap">
